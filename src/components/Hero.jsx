        ...
        >
          <Box
            sx={{
              ...
              alignItems: "stretch",
              overflow: "hidden",
              // switch to column on small screens so tiles stack
          ...
          >
            {items.map((t, i) => {
              ...
              // flex ratio - active gets more space on md+
              const flexActive = 6;
              ...
              return (
                <MotionBox
                  ...
                  sx={{
                    ...
                    // responsive flex: full width on xs, accordion behavior on md+
                    flex: {
                      xs: "0 0 auto",
                      md: isActive ? flexActive : flexInactive,
                    },
                    ...
                    {isActive && (
                      ...
                      >
                        ...
                        <Stack direction="row" spacing={1}>
                          <Button size="small" variant="contained" onClick={() => view(i)}>
                            Open
                          </Button>
                          <Button size="small" variant="outlined" onClick={() => setHover(null)}>
                            Close
                          </Button>
                        </Stack>
                      </motion.div>
            ...
            >
              ...
              >
                ...
                <Stack direction="row" spacing={1.5} sx={{ mt: 2 }}>
                  <Button
                    variant="contained"
                    href={`${site.brand.ctaLink || "/start"}?itemId=hero-${idx}`}
                  >
                    Start a project
                  </Button>
